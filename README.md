...
Data source: Wikipedia - [List of highest-grossing films](https://en.wikipedia.org/wiki/List_of_highest-grossing_films)

## 👤 Author

Created as part of data engineering course (AS1 DWAV)

---

## 🤝 Contributing

Found a bug or have suggestions? Check the code and feel free to submit improvements!
